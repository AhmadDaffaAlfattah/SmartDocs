...
@section('title', 'SmartDocs - Business Support')
...
@section('content')
    ...
    <div class="filter-section">
        ...
        <div class="search-box" style="margin-left: 15px;">
            <form method="GET" action="{{ route('business-support.index') }}" style="display: flex; align-items: center;">
                            ...
                            <tr>
                                ...
                                <td class="action">
                                    @if ($document->file_path)
                                        <a href="{{ route('business-support.viewer', $document->id) }}" class="action-btn" title="View" target="_blank">
                                    ...
                                    @if(Auth::user()->role === 'super_admin' || Auth::user()->role === 'admin')
                                        <a href="{{ route('business-support.edit', $document->id) }}" class="action-btn" title="Edit">
                                            <img src="https://cdn-icons-png.flaticon.com/128/14034/14034493.png" alt="Edit" width="24" height="24">
                                        </a>
                                        <form id="delete-form-{{ $document->id }}" action="{{ route('business-support.destroy', $document->id) }}" method="POST" style="display: inline;" onsubmit="event.preventDefault(); confirmDelete('delete-form-{{ $document->id }}');">
                                            @csrf
                                            @method('DELETE')
