...
<head>
    ...
    <title>SmartDocs - Business Support</title>
...
<body>
            ...
            <div class="landing-main">
                <div class="engineering-page-header">
                    <div class="engineering-page-title">
                        <div style="font-size: 28px; font-weight: bold; color: #333333; margin-bottom: 20px;">
                            Document <span style="font-weight: bold;">» Business Support</span>
                        </div>
                        <a href="{{ route('business-support.create') }}" class="btn-tambah-data">
                            ➕ Tambah Data
                        </a>
                    </div>
                </div>
                ...
                <div class="filter-section">
                    ...
                    <div class="search-box">
                        <form method="GET" action="{{ route('business-support.index') }}" style="display: flex; width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="action">
                                                @if ($document->file_path)
                                                    <a href="{{ route('business-support.viewer', $document->id) }}" class="action-btn view" title="View" target="_blank">
                                                ...
                                                <form action="{{ route('business-support.destroy', $document->id) }}" method="POST" style="display: inline;" onsubmit="return confirm('Yakin ingin menghapus dokumen ini?');">
                                                    @csrf
                                                    @method('DELETE')
    ...
    function openEditModal(documentId) {
        ...
        fetch(`/business-support/${documentId}/get-edit-data`)
            ...
            .then(data => {
                ...
                if (data.document.file_path) {
                    fileInfo = `<strong>File saat ini:</strong> <a href="/business-support/${data.document.id}/download">${data.document.file_name}</a>`;
                }
    ...
    function submitEditForm() {
        ...
        fetch(`/business-support/${documentId}`, {
            method: 'POST',
            body: formData,
