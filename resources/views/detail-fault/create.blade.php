...
<head>
    ...
    <title>SmartDocs - Tambah Detail Fault</title>
            ...
            <div class="landing-main">
                <div class="form-container">
                    <div class="form-header">
                        <h1>Tambah Detail Fault</h1>
                    </div>

                    <form action="{{ route('detail-fault.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="asset_wellness_id" required>
                                    ...
                                    @foreach($assets as $asset)
                                        <option value="{{ $asset->id }}" {{ old('asset_wellness_id') == $asset->id ? 'selected' : '' }}>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" name="unit_pembangkit" value="{{ old('unit_pembangkit') }}" required>
                                @error('unit_pembangkit')<div class="error-message">{{ $message }}</div>@enderror
                            </div>
                            <div class="form-group">
                                <label>Tanggal Identifikasi</label>
                                <input type="date" name="tanggal_identifikasi" value="{{ old('tanggal_identifikasi') }}">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="text" name="status_saat_ini" value="{{ old('status_saat_ini') }}">
                            </div>
                            <div class="form-group">
                                <label>Asset Description</label>
                                <input type="text" name="asset_description" value="{{ old('asset_description') }}">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="action_plan" value="{{ old('action_plan') }}">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="progres_saat_ini" value="{{ old('progres_saat_ini') }}">
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <input type="date" name="realisasi_selesai" value="{{ old('realisasi_selesai') }}">
                            </div>
                            <div class="form-group">
                                <label>Main Issue / Kendala</label>
                                <input type="text" name="main_issue_kendala" value="{{ old('main_issue_kendala') }}">
                            </div>
                        </div>
