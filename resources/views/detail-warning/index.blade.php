...
<head>
    ...
    <title>SmartDocs - Detail Warning</title>
            ...
            <div class="landing-main">
                <div class="asset-container">
                    <div class="asset-header">
                        <div>
                            <h1>Detail Warning - Semua Mesin</h1>
                        </div>
                    </div>
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; flex-wrap: wrap; gap: 10px;">
                        ...
                        <form action="{{ route('detail-warning.index') }}" method="GET" style="display: flex; gap: 8px; align-items: center;">
                            <!-- Month Filter -->
                            ...
                            <button type="submit" style="padding: 8px 12px; background: #5dade2; color: white; border: none; border-radius: 4px; cursor: pointer;">🔍 Cari</button>
                            
                            @if(request('search') || request('bulan') || request('tahun') || request('sentral'))
                                <a href="{{ route('detail-warning.index') }}" style="padding: 8px 12px; background: #999; color: white; border: none; border-radius: 4px; text-decoration: none;">Reset</a>
                            @endif
                        </form>
                    </div>
                    ...
                    <div class="table-wrapper">
                        <table>
                            ...
                            <tbody>
                                @forelse($detailWarnings as $key => $detail)
                                    <tr>
