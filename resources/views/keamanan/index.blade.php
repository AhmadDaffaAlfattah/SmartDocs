                        ...
                        @foreach ($documents as $key => $document)
                            <tr>
                                ...
                                <td class="action">
                                    ...
                                    <form id="delete-form-{{ $document->id }}" action="{{ route('keamanan.destroy', $document->id) }}" method="POST" style="display: inline;" onsubmit="event.preventDefault(); confirmDelete('delete-form-{{ $document->id }}');">
                                        @csrf
                                        @method('DELETE')
