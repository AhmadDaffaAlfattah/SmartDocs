...
<body>
                ...
                <div class="viewer-container">
                    <div class="viewer-header">
                        ...
                        <div class="viewer-controls">
                            <a href="{{ route('keamanan.index') }}" class="btn-back">← Kembali</a>
                    ...
                    @else
                        <div style="padding: 40px; text-align: center; color: #999;">
                            ...
                            <a href="{{ route('keamanan.download', $document->id) }}" class="btn-download" style="display: inline-block; margin-top: 20px;">📥 Download File</a>
                        </div>
                    @endif
    ...
    const getFileUrl = '/keamanan/' + documentId + '/get-file';
    ...
    function downloadFile() {
        window.location.href = '{{ route('keamanan.download', $document->id) }}';
    }
