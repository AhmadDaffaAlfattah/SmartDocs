...
@section('title', 'SmartDocs - Pemeliharaan')
...
@section('content')
    ...
    <div class="engineering-page-header">
        <div class="engineering-page-title">
            <div style="font-size: 28px; font-weight: bold; color: #333333; margin-bottom: 20px;">
                Document <span style="font-weight: bold;">» Pemeliharaan</span>
            </div>
            <a href="{{ route('pemeliharaan.create') }}" class="btn-tambah-data">
                ➕ Tambah Data
            </a>
        </div>
    </div>
    ...
    <div class="filter-section">
        ...
        <div class="search-box">
            <form method="GET" action="{{ route('pemeliharaan.index') }}" style="display: flex; width: 100%;">
                            ...
                            <tr>
                                ...
                                <td class="action">
                                    @if ($document->file_path)
                                        <a href="{{ route('pemeliharaan.viewer', $document->id) }}" class="action-btn view" title="View" target="_blank">
...
@push('scripts')
    ...
    function openEditModal(documentId) {
        ...
        fetch(`/pemeliharaan/${documentId}/get-edit-data`)
            ...
            .then(data => {
                ...
                if (data.document.file_path) {
                    fileInfo = `<strong>File saat ini:</strong> <a href="/pemeliharaan/${data.document.id}/download">${data.document.file_name}</a>`;
                }
