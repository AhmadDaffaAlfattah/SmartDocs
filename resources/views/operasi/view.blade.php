...
@section('content')
    @php
        $fileType = strtolower($document->file_type ?? pathinfo($document->file_path, PATHINFO_EXTENSION));
    @endphp
    ...
    <div class="viewer-container">
        <div class="viewer-header">
            ...
            <div class="viewer-controls">
                <a href="{{ route('operasi.index') }}" class="btn-back">← Kembali</a>
        ...
        @else
            <div style="padding: 40px; text-align: center; color: #999;">
                ...
                <a href="{{ route('operasi.download', $document->id) }}" class="btn-download" style="display: inline-block; margin-top: 20px;">📥 Download File</a>
            </div>
        @endif
...
<script>
    ...
    const getFileUrl = '/operasi/' + documentId + '/get-file';
    ...
    function downloadFile() {
        window.location.href = '{{ route('operasi.download', $document->id) }}';
    }
</script>
@endpush
