...
<body>
            ...
            <div class="landing-main">
                ...
                <div class="filter-section">
                    ...
                    <div class="search-box">
                        <form method="GET" action="{{ route('operasi.index') }}" style="display: flex; width: 100%;">
                                        ...
                                        <tr>
                                            ...
                                            <td class="action">
                                                @if ($document->file_path)
                                                    <a href="{{ route('operasi.viewer', $document->id) }}" class="action-btn view" title="View" target="_blank">
    ...
    function openEditModal(documentId) {
        ...
        fetch(`/operasi/${documentId}/get-edit-data`)
            ...
            .then(data => {
                ...
                if (data.document.file_path) {
                    fileInfo = `<strong>File saat ini:</strong> <a href="/operasi/${data.document.id}/download">${data.document.file_name}</a>`;
                }
