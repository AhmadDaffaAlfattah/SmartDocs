...
use App\Models\KeamananDocument;
...
class KeamananController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $folders = KeamananDocument::getFolders();
    ...
    public function create()
    {
        $folders = KeamananDocument::getFolders();
        $folderTree = $this->getFilteredFolders();
        return view('keamanan.create', ['folders' => $folders, 'folderTree' => $folderTree]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            $path = $file->storeAs('keamanan-documents', $filename, 'public');
    ...
    {
        $document = KeamananDocument::findOrFail($id);
        $folders = KeamananDocument::getFolders();
        $folderTree = $this->getFilteredFolders();
    ...
    public function view($id)
    {
        ...
        return view('keamanan.view', ['document' => $document]);
    }
    ...
    public function viewer($id)
    {
        ...
        if (!$document->file_path || !Storage::disk('public')->exists($document->file_path)) {
            return redirect()->route('keamanan.index')->with('error', 'File tidak ditemukan!');
        }
