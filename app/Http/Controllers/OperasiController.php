...
use App\Models\OperasiDocument;
...
class OperasiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $folders = OperasiDocument::getFolders();
    ...
    public function create()
    {
        $folders = OperasiDocument::getFolders();
        $folderTree = $this->getFilteredFolders();
        return view('operasi.create', ['folders' => $folders, 'folderTree' => $folderTree]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('file')) {
            ...
            $path = $file->storeAs('operasi-documents', $filename, 'public');
        ...
        return redirect()->route('operasi.index')
            ->with('success', 'Dokumen berhasil ditambahkan!');
    }

    public function edit($id)
    {
        $document = OperasiDocument::findOrFail($id);
        $folders = OperasiDocument::getFolders();
        $folderTree = $this->getFilteredFolders();

        return view('operasi.edit', [
            'document' => $document,
            'folders' => $folders,
            'folderTree' => $folderTree,
        ]);
    ...
    public function view($id)
    {
        ...
        return view('operasi.view', ['document' => $document]);
    }
    ...
    public function viewer($id)
    {
        ...
        if (!$document->file_path || !Storage::disk('public')->exists($document->file_path)) {
            return redirect()->route('operasi.index')->with('error', 'File tidak ditemukan!');
        }
