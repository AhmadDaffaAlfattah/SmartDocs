...
use App\Models\PemeliharaanDocument;
...
class PemeliharaanController extends Controller
{
    ...
    {
        $query = PemeliharaanDocument::query();
        ...
        $folders = PemeliharaanDocument::getFolders();
    ...
    public function create()
    {
        $folders = PemeliharaanDocument::getFolders();
        $folderTree = $this->getFilteredFolders();
        return view('pemeliharaan.create', ['folders' => $folders, 'folderTree' => $folderTree]);
    }
    ...
    public function store(Request $request)
    {
        ...
        $document = new PemeliharaanDocument();
        ...
        if ($request->hasFile('file')) {
            ...
            $path = $file->storeAs('pemeliharaan-documents', $filename, 'public');
    ...
    {
        $document = PemeliharaanDocument::findOrFail($id);
        $folders = PemeliharaanDocument::getFolders();
        $folderTree = $this->getFilteredFolders();
    ...
    public function view($id)
    {
        ...
        return view('pemeliharaan.view', ['document' => $document]);
    }
    ...
    public function viewer($id)
    {
        ...
        if (!$document->file_path || !Storage::disk('public')->exists($document->file_path)) {
            return redirect()->route('pemeliharaan.index')->with('error', 'File tidak ditemukan!');
        }
        ...
        return view('pemeliharaan.viewer', [
            'document' => $document,
            'fileType' => $fileType,
