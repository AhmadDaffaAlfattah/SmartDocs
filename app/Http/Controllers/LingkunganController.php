...
use App\Models\LingkunganDocument;
...
class LingkunganController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $document = new LingkunganDocument();
        ...
        if ($request->hasFile('file')) {
            ...
            $path = $file->storeAs('lingkungan-documents', $filename, 'public');
    ...
    public function view($id)
    {
        ...
        return view('lingkungan.view', ['document' => $document]);
    }
    ...
    public function viewer($id)
    {
        ...
        if (!$document->file_path || !Storage::disk('public')->exists($document->file_path)) {
            return redirect()->route('lingkungan.index')->with('error', 'File tidak ditemukan!');
        }
