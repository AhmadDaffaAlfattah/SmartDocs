...
class DetailWarningSheet implements FromCollection, WithHeadings, WithStyles, \Maatwebsite\Excel\Concerns\WithTitle
{
    public function collection()
    {
        return DetailWarning::with('assetWellness')
