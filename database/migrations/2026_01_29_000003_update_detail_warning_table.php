...
return new class extends Migration
{
    ...
    {
        Schema::table('detail_warning', function (Blueprint $table) {
            // Drop existing columns if exists
            if (Schema::hasColumn('detail_warning', 'status_saat_ini')) {
                $table->dropColumn('status_saat_ini');
            }
            if (Schema::hasColumn('detail_warning', 'apa_yang_diinginkan')) {
                $table->dropColumn('apa_yang_diinginkan');
            }
            if (Schema::hasColumn('detail_warning', 'kendala_dari')) {
                $table->dropColumn('kendala_dari');
            }
            if (Schema::hasColumn('detail_warning', 'action_dari')) {
                $table->dropColumn('action_dari');
            }
            if (Schema::hasColumn('detail_warning', 'target_dari')) {
                $table->dropColumn('target_dari');
            }
            if (Schema::hasColumn('detail_warning', 'progress_hari')) {
                $table->dropColumn('progress_hari');
            }
            if (Schema::hasColumn('detail_warning', 'beberapa_metode')) {
                $table->dropColumn('beberapa_metode');
            }
            if (Schema::hasColumn('detail_warning', 'status_kendala')) {
